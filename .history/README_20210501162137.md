...
This projects featured by api integration with web application. In this projects I used [The sports db api](https://www.thesportsdb.com/api.php). Its allows applications to communicate with backend systems.
